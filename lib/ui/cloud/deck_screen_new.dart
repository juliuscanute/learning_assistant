...
class DecksScreenNew extends StatefulWidget {
  final firebaseService = ServiceLocator.instance.get<FirebaseService>();
  DecksScreenNew({Key? key}) : super(key: key);

  @override
  _DecksScreenNewState createState() => _DecksScreenNewState();
}

class _DecksScreenNewState extends State<DecksScreenNew> {
  @override
